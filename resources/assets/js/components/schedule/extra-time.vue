      ...
      <div class="panel panel-default">
        ...
        <div v-show="!loading">
          ...
          <div :class="panelClass">
                  ...
                  <tr>
                    ...
                    <th>
                      ...
                      <p>
                          ...
                          <span :class="filterClasses('name')" @click="filterColumn('name',{object:'states',search:['name'],nullName:'Indiferente'})"></span>
                      </p>
                    </th>
                    <th>
                      Provincia
                    ...
                    <th>
                      ...
                      <p>
                          ...
                          <span :class="filterClasses('city')" @click="filterColumn('city',{object:'clinic',search:['city','address_real_1','address_real_2'],nullName:'Indiferente',noOptions:true})"></span>
                      </p>
                    </th>
                    <th class="hidden-xs">
                      Fecha
            ...
            <div id="noextratime" v-if="!extratimes.length && admin" class=" text-center empty">
