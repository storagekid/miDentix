...
<head>
    ...
    <title>Bankia. Abierto el plazo IBI y otros impuestos Alicante</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
  ...
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #FFFFFF;">
    ...
    <![endif]-->
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
          Abierto el plazo, impuesto sobre Bienes Inmuebles y otros tributos. Alicante.
        </div>
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;" class="email-container">
          ...
          <tr>
            ...
            <!-- Clear Spacer : BEGIN -->
            <tr>
                <td aria-hidden="true" height="25" style="font-size: 0px; line-height: 0px; background-color: #b9c800;">
                    &nbsp;
                </td>
            </tr>
            <!-- Clear Spacer : END -->
            ...
            <tr>
                <td style="background-color: #e0e0e0; text-align: center">
                    <img src="http://www.storagekid.com/mozodealmacen/images/main_info.jpg" width="600" height="" title="Abierto el plazo IBI Alicante" alt="Abierto el plazo IBI Alicante" border="0" style="width: 100%; max-width: 600px; height: auto; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;; font-size: 15px; line-height: 15px; color: #333333; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
            <!-- Hero Image, Flush : END -->
            <!-- Thumbnail Left, Text Right : BEGIN -->
            <tr>
              <td dir="ltr" valign="middle" width="100%" style="padding: 25px 60px;">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                          <!-- Column : BEGIN -->
                          <th valign="middle" width="85" class="stack-column-center">
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                  <tr>
                                      <td dir="ltr" valign="middle">
                                          <img src="http://www.storagekid.com/mozodealmacen/images/desktop_mobile.png" width="85" height="" title="Acceso descuento online" alt="Acceso descuento online" border="0" class="center-on-narrow" style="height: auto; font-family:'BankiaMedium','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 700; font-size: 15px; line-height: 15px; color: #352a20;">
                                      </td>
                                  </tr>
                              </table>
                          </th>
                          <!-- Column : END -->
                          <!-- Column : BEGIN -->
                          <th valign="middle" width="350" style="padding-left: 25px">
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                  <tr>
                                      <td dir="ltr" valign="middle" style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 500; font-size: 24px; line-height: 26px; color: #352a20; text-align: justify">
                                        Accede a
                                        <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> Gestiones en curso </strong>
                                        desde tu
                                        <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> App de Bankia </strong>
                                        o
                                        <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> Bankia Online </strong>
                                        y
                                      </td>
                                    </tr>
                              </table>
            ...
            <!-- 1 Column Text : BEGIN -->
            <tr>
                <td style="background-color: #ffffff; padding: 0px 60px; text-align: center">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600; font-size: 39px; line-height: 41px; color: #b9c800; padding-bottom: 5px">
                              ACEPTA TU PROMOCIÓN
                            </td>
                        </tr>
                        <tr>
                            <td style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600; font-size: 39px; line-height: 41px; color: #b9c800;">
                              XXXXXXXXXXX
                            </td>
                        </tr>
                    </table>
            ...
            <!-- 1 Column Text : BEGIN -->
	        <tr>
            <td style="background-color: #FFFFFF; padding: 30px 60px; color: #000000">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 16px; line-height: 18px; color: #000000; text-align: center">
                          Consulta
                          <span><a href="#" target="_blank" style="font-family:'BankiaMedium','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 700; color:#000000; text-decoration: underline"> aquí </a></span>
          ...
          <!-- 1 Column Text : END -->
            <!-- 1 Column Text : BEGIN -->
	        <tr>
            <td style="padding: 0px 60px; color: #333333; background-color: #FFFFFF">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 500; font-size: 22px; line-height: 24px; color: #FFFFFF; text-align: justify; background-color: #b9c800; padding: 25px 40px">
                          Entra en tu
                          <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> Buzón/Gestiones en curso </strong>
                          en
                          <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> Bankia Online </strong>
                          o accede a través de tu
                          <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> área personal </strong>
                          en la
                          <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;"> App de Bankia.</strong>
                        </td>
                    </tr>
