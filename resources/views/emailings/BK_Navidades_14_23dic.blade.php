...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #eeeeee;">
  <center role="article" aria-roledescription="email" lang="es" style="width: 100%; background-color: #eeeeee;">
    ...
    <![endif]-->
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                          ...
                          <tr>
                            <td class="icon-text" style="font-family:'BankiaLight','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; font-weight: 300; color: #000000; padding: 10px 30px 15px 30px; text-align: center;" class="">
                                <span style="margin: 0;">Este año lo merecen más que nunca, se han ganado un juguete o dos. Bankia Shop te ofrece esta selección de juguetes para ti y los tuyos. ¡Disfrútalos!</span>
                            </td>
                          </tr>
                      </table>
                      <!--[if mso]>
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                          ...
                          <tr>
                            <td class="icon-text" style="font-family:'BankiaLight','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; font-weight: 300; color: #000000; padding: 15px 20px; text-align: center;" class="">
                                <span style="margin: 0;">Lo estabas esperando y ahora es el momento. Tú también mereces un regalo, Bankia Shop te lo pone fácil financiando tus compras. Estás a un clic de darte un capricho.</span>
                            </td>
                          </tr>
                      </table>
                      <!--[if mso]>
        ...
        <tr>
          <td style="background-color: #ffffff; padding-left: 30px; padding-right: 30px">
              <img src="https://imagenes.vdshop.es/footer-hero-navidad.jpg" width="540" height="" alt="Nueva Sección Gourmet" border="0" style="width: 100%; max-width: 540px; height: auto; background: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #000000; margin: auto; display: block;" class="g-img">
          </td>
        </tr>
        <!-- Hero Image, Flush : END -->
        <tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                      <td style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600; font-size: 27px; line-height: 27px; color: #000000; padding: 0; text-align: center; padding-top: 20px;">
                        Llévate los mejores productos para tu mesa
                      </td>
                  </tr>
                  <tr>
                      <td class="m-padding" style="font-family:'BankiaLight','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 20px; line-height: 23px; font-weight: 300; color: #000000; padding: 5px 60px 0; text-align: center;">
                        Nueva <span style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600; color: #e4a935;">sección Gourmet</span> de Bankia Shop, con la garantía de Aula Española del Vino
                      </td>
                  </tr>
                  <tr>
                      <td class="icon-text" style="font-family:'BankiaLight','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; font-weight: 300; color: #000000; padding: 20px 60px 0px; text-align: center;">
                        Lo veo, lo quiero, lo disfruto. Así de fácil. Productos delicatessen sin salir de casa. Bankia Shop te quiere alegrar la vida y la mesa. Productos pensados para ti y tu familia.<br class="hide-on-mobile">Para una Navidad especial.
                      </td>
                  </tr>
              </table>
          </td>
        ...
        <tr>
          <td style="background-color: #ffffff; padding-left: 30px; padding-right: 30px">
              <img src="https://imagenes.vdshop.es/free-shipping.jpg" width="540" height="" alt="Envío Gratis" border="0" style="width: 100%; max-width: 540px; height: auto; background: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #000000; margin: auto; display: block;" class="g-img">
          </td>
        </tr>
        <!-- Hero Image, Flush : END -->
        <tr>
