...
<head>
    ...
    <title>Bankia. Accede a tus promociones</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;" class="email-container">
          ...
          <tr>
                <td style="background-color: #ffffff; text-align: center">
                  <img style="display:block; cursor: default;" src="http://www.storagekid.com/mozodealmacen/images/bankia_header.jpg" width="600" height="" alt="Bankia. Así de fácil" title="Bankia. Así de fácil" border="0" />
                </td>
            </tr>
            ...
            <tr>
                <td style="background-color: #e0e0e0; text-align: center">
                    <img src="http://www.storagekid.com/mozodealmacen/images/main_info.jpg" width="600" height="" title="Tus Promociones" alt="Tus Promociones" border="0" style="width: 100%; max-width: 600px; height: auto; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;; font-size: 15px; line-height: 15px; color: #333333; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
            <!-- Hero Image, Flush : END -->
            <!-- Clear Spacer : BEGIN -->
            <tr>
                <td aria-hidden="true" height="25" style="font-size: 0px; line-height: 0px; background-color: #FFFFFF;">
                    &nbsp;
                </td>
            </tr>
            <!-- Clear Spacer : END -->
            ...
            <tr>
                <td style="background-color: #e0e0e0; text-align: center">
                    <img src="http://www.storagekid.com/mozodealmacen/images/desktop_mobile_info.jpg" width="600" height="" title="Info acceso a tus promociones" alt="Info acceso a tus promociones" border="0" style="width: 100%; max-width: 600px; height: auto; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;; font-size: 15px; line-height: 15px; color: #333333; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
            <!-- Hero Image, Flush : END -->
            <!-- Clear Spacer : BEGIN -->
