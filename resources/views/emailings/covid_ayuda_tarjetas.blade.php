  ...
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #FFFFFF;">
    ...
    <![endif]-->
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
          Primero te esperamos y ahora fraccionamos tus recibos.
        </div>
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;" class="email-container">
          ...
          <tr>
            ...
            <tr>
                <td style="background-color: #ffffff;">
                    <img src="http://www.storagekid.com/mozodealmacen/images/covid_cards.jpg" width="600" height="" title="Primero te esperamos y ahora fraccionamos tus recibos." alt="Primero te esperamos y ahora fraccionamos tus recibos." border="0" style="width: 100%; max-width: 600px; height: auto; background: #FFFFFF; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif;; font-size: 15px; line-height: 15px; color: #FF9E1B; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
            <!-- Hero Image, Flush : END -->
            ...
            <!-- 1 Column Text : BEGIN -->
	        <tr>
	            <td style="padding: 30px 0 15px 0; color: #333333">
	                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
	                    <tr>
	                        <td style="font-family:'BankiaMedium','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 15px; line-height: 22px; color: #333333; padding: 0 30px; text-align: center;">
                          Sabemos que la situación que estamos viviendo no es fácil, por eso en mayo te ofrecimos posponer el pago de tu recibo de tarjeta de crédito dos meses más. <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 700;">El próximo 1 de julio se cumple el plazo</strong> y te llegará el recibo correspondiente, pero queremos seguir poniéndotelo fácil. <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 700;">Ahora puedes fraccionar el recibo en 3 mensualidades.</strong>
	                        </td>
                      </tr>
	                </table>
	            </td>
            ...
            <tr>
                <td style="background-color: #ffffff;">
                    <img src="http://www.storagekid.com/mozodealmacen/images/3months.jpg" width="600" height="" title="3 meses sin intereses" alt="3 meses sin intereses" border="0" style="width: 100%; max-width: 600px; height: auto; background: #FFFFFF; font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 15px; line-height: 15px; color: #FF9E1B; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
            <!-- Hero Image, Flush : END -->
              ...
              <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                <tr>
                  <td class="button-td button-td-primary" style="border-radius: 6px; background: #FF9E1B;">
                    <a class="button-a button-a-primary" href="https://www.bankia.es/es/particulares/coronavirus/ayudas/tarjetas-de-credito##cp-tab-2" style="background: #FF9E1B; font-family:'BankiaMedium','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 15px; line-height: 20px; text-decoration: none; padding: 13px 25px; color: #ffffff; display: block; border-radius: 6px;">MÁS INFORMACIÓN</a>
                  </td>
                </tr>
              </table>
            </td>
        ...
        <!-- Button : END -->
         ...
         <tr>
          <td style="padding: 0; color: #333333">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                      <td style="font-family:'BankiaMedium','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 15px; line-height: 17px; color: #333333; padding: 0 30px; text-align: center;">
                        #JuntosEsMásFácil
                      </td>
                  </tr>
              </table>
        ...
        <!-- 1 Column Text : END -->
            ...
            <!-- 1 Column Text : BEGIN -->
	        <tr>
	            <td style="background-color: #FFFFFF; padding: 20px 0 0 0; color: #FFFFFF">
	                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
            ...
            <tr>
              <td style="background-color: #FFFFFF; padding: 30px; color: #333333; text-align: justify">
