          ...
          <tr>
	        ...
	        <tr>
	            <td style="background-color: #98a2ab; padding: 30px 60px; color: #FFFFFF">
	                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
	                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 20px; color: #FFFFFF;">
	        ...
	        <tr>
	            <td style="background-color: #FFFFFF; padding: 30px; color: #FFFFFF; border-bottom: 2px solid #98a2ab">
	                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 20px; color: #FFFFFF; text-align: center;">
