                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; color: #35261a; text-align: center; background-color: #c7d333; padding: 0 10px 8px 10px">
                          Accede en <a href="http://bankia.es" style="color:#35261a; text-decoration:none;">bankia.es</a>, al botón <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;">Acceso Clientes</strong><br>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; color: #35261a; text-align: center; background-color: #c7d333; padding: 0 50px 15px 50px">
                          Entra en <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;">Transferencias y Servicios</strong> y selecciona <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;">Pagar Recibos</strong>
                        </td>
                    </tr>
                </table>
            </td>
          ...
          <tr>
            <td style="padding: 0 70px 0 70px; color: #333333; background-color: #FFFFFF">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; color: #35261a; text-align: center; background-color: #c7d333; padding: 0 25px 8px 25px">
                          Accede en <a href="http://bankia.es" style="color:#35261a; text-decoration:none;">bankia.es</a>, al botón <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;">Acceso Empresas</strong> situado en la pestaña <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;">Empresas</strong><br>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family:'BankiaRegular','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-size: 18px; line-height: 22px; color: #35261a; text-align: center; background-color: #c7d333; padding: 0 25px 15px 25px">
                          Entra en <strong style="font-family:'BankiaBold','Source Sans Pro',Tahoma,Verdana,Segoe,sans-serif; font-weight: 600;">Pagos / Realizar Pago de Recibos y Tributos</strong>
                        </td>
                    </tr>
                </table>
            </td>
