...
module.exports.easing = __webpack_require__(140);
module.exports.canvas = __webpack_require__(141);
module.exports.options = __webpack_require__(142);
...
module.exports = {};
module.exports.Arc = __webpack_require__(148);
module.exports.Line = __webpack_require__(149);
module.exports.Point = __webpack_require__(150);
module.exports.Rectangle = __webpack_require__(151);
...
var string = __webpack_require__(146);
...
var helpers = __webpack_require__(2);
var basic = __webpack_require__(152);
var dom = __webpack_require__(153);
...
Chart.elements = __webpack_require__(9);
...
/* MIT license */
var colorNames = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chart_js__ = __webpack_require__(138);
...
//     options: options
// });
var myBarChart = new __WEBPACK_IMPORTED_MODULE_0_chart_js___default.a(contextBar, {
	type: 'bar',
	data: data2,
	options: options
});
var myPieChart = new __WEBPACK_IMPORTED_MODULE_0_chart_js___default.a(contextPie, {
	type: 'pie',
	data: data3,
	options: {
		...
		legend: {
			onClick: function onClick(e, item) {
				console.log('LAbel');
				console.log(item);
				__WEBPACK_IMPORTED_MODULE_0_chart_js___default.a.defaults.pie.legend.onClick.call(this, e, item);
			}
		},
		onClick: function onClick(e, item) {
			if (!item[0]) {
			...
			var filter = 'type';
			var subject = cleanUpSpecialChars(item[0]._model.label.toLowerCase());
			window.location.href = '/requests?' + filter + '=' + subject;
		}
	}
});
var myLineUsersChart = new __WEBPACK_IMPORTED_MODULE_0_chart_js___default.a(contextUsersLine, {
	type: 'line',
	data: dataUsersLine,
	options: options
});
var myPieUsersChart = new __WEBPACK_IMPORTED_MODULE_0_chart_js___default.a(contextUsersPie, {
	type: 'doughnut',
	data: dataUsersPie,
	options: options
});
